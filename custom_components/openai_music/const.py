...
MAX_RETRIES = 2
IMAGE_PROMPT = "Inspired by [Song] and in the style of [Style], create a singular image that reflects the song's meaning and interpretation through specific, evocative visual imagery. The imagery should align with the style. Make the visualization lively and engaging."
PERSONALITIES = {
