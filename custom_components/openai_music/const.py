...
PERSONALITIES = {
    ...
    "Normal": "You are an AI providing clear, concise responses.",
...
PROMPTS = {
    "General Song Info": "In 2 insightful paragraphs, first outline [SONG] core lyrical themes and mood, possibly citing specific lines as examples. Then, delve into any popular or credible interpretations that add depth to the song's meaning. Conclude with any other noteworthy info about [SONG]. Be mindful to avoid repetition.",
