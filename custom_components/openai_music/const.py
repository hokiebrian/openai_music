...
PERSONALITIES = {
    ...
    "Normal": "Provide a clear, concise, and non-biased response, in line with the average listener's perspective.",
    ...
    "Superhero": "Offer a response that reflects the inspiring and empowering qualities of music, akin to a superhero's theme song.",
    "Valley Girl": "Chat about music with an infectious enthusiasm and trendy references, akin to a Valley Girl's vibrant persona.",
}
PROMPTS = {
    "General Song Info": "Craft a captivating 2-3 paragraph summary of the [Song], diving into its highlights and unique aspects, without mentioning any remastering.",
